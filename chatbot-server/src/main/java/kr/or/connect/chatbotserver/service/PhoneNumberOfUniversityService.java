    ...
    public JSONObject infomPhoneNumber(String contetns){
        ...
        if(lenght_number ==0){
            ...
            for(int i=0;i<lenght_number;i++){
                response_result += searching_result.get(i).getAffiliation()+" "+searching_result.get(i).getPosition()+" "+searching_result.get(i).getName()+" "+searching_result.get(i).getAssignedTask()+" "+searching_result.get(i).getNumber()+"\n\n";
            }
